...
export class MascotaComponent implements OnInit {
  ...
  constructor(
    private serviceMas: MascotaService,
  ...
  refresh() {
    this.serviceMas.selectallMascota().subscribe(
      (datos) => {
  ...
  saveMas() {
    this.serviceMas.saveMascota(this.formMas.value).subscribe(
      (resp) => {
        console.log(resp);
        this.formMas.reset();
        this.refresh();
  ...
  deleteMas() {
    this.serviceMas.deleteMascota(this.formMas.value).subscribe(
      (resp) => {
        console.log(resp);
        this.refresh();
      },
